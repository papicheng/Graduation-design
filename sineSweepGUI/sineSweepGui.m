...
% Last Modified by GUIDE v2.5 07-Jan-2018 14:46:40
...
global closeflag openflag prbsflag sinesweepflag changerate amprate
...
%                     cthann=ct;
%                     cthannfft=fft(ct);
%                     cthannfftmag(i-2)=abs(cthannfft(f_num))/(N/2);
%                     
%                     
%                     maghannrate(i-2)=cthannfftmag(i-2)/num_mag(i-2);%幅值比
